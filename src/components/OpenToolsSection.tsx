...
const OpenToolsSection: React.FC = () => {
  return (
    <section
      id="tools"
      className="spotlight relative py-16 sm:py-20 md:py-24 bg-surface border-t border-border"
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-[-0.025em] text-fg mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {tools.map((tool, index) => (
            ...
            >
              <GlowCard className="group flex h-full flex-col rounded-2xl border border-border bg-surface-elevated p-6 sm:p-8">
                <div className="flex items-start justify-between gap-4">
                  <div className="inline-flex p-2.5 rounded-xl bg-accent-soft border border-accent-border/50">
                ...
                <span className="mt-6 inline-flex w-fit items-center rounded-full border border-border bg-surface-subtle px-3 py-1 text-xs font-medium text-fg-subtle">
                  Free · React
                </span>
              </GlowCard>
            </motion.a>
